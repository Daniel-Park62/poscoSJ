...
public class RegStand2 extends Dialog {
	...
	private class ContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object input) {
			return ((List<TbStand2>) input).toArray();
		}
	...
	String[] cols = { "", "Stand", "", "경고온도", "", "위험온도", "", "표시범위(시간)" };
...
//        parent.getShell().pack();
	...
	public void refreshList() {
		tempList = new ArrayList<TbStand2>();

		em.clear();
		em.getEntityManagerFactory().getCache().evictAll();

		tempList = em.createQuery("select t from TbStand2 t ", TbStand2.class).getResultList();
...
//		}
	...
	private class MyLabelProvider implements ITableLabelProvider {
		...
		public String getColumnText(Object element, int columnIndex) {
			TbStand2 tbstand = (TbStand2) element;
			switch (columnIndex) {
			case 1:
				return tbstand.getStand() ;
			case 2:
